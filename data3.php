    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="active"><a href="data3.php"><i class="fa fa-book"></i> <span>Decision Making</span></a>
    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"> Decision Making </li>
            </ul>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <span>Calculate Collision.</span>
                <form action="models/addCollision.php" method="post">
                
                <button class="btn btn-success" type="submit" name="submit">Hitung</button>
                </form>
                
                <span>Insert Collision. </span>
                <form action="models/insertCollision.php" method="post">
                
                <button class="btn btn-success" type="submit" name="submit">Cari Keputusan</button>
                </form>
            </div>
            </div>
        </section>
